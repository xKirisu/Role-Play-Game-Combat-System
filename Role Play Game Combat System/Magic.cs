        ...
        static Dictionary<string, Spell> AllSpells = new Dictionary<string, Spell>
            {
                ...
                { "Fire_Ball",          new Spell("Fire_Ball",           1.8f,   2, DamageType.Magical,                 false, true) },
                { "Lightning",          new Spell("Lightning",           2.5f,   6, DamageType.Magical, Status.Weakness,   true, true) },
                ...
                { "Divine_Chastiment",  new Spell("Divine_Chastiment",   1.8f,   8, DamageType.Magical, Status.Weakness,   true, true ) },
                { "Condamnation",       new Spell("Condamnation",        1.8f,   6, DamageType.Phisical,                true, true) },
                ...
                { "Decapitation",       new Spell("Decapitation",        3.5f,     8, DamageType.Other,                     true, true) },
                { "Perish",             new Spell("Perish",              4f,     8, DamageType.Magical,                  true, true) },
                { "Ice_Shard",          new Spell("Ice_Shard",           2f,   8, DamageType.Magical,                  true, true) },
                ...
                { "Deathly_Reap",       new Spell("Deathly_Reap",        3.5f,     8, DamageType.Magical,                  true, true) },
                { "Virgin_Fate",        new Spell("Virgin_Fate",         0.5f,   4, DamageType.Magical, Status.Prowess,  false, false) },
                { "Swat",               new Spell("Swat",                1.5f,   4, DamageType.Phisical, Status.Weakness,   true, true) },
                ...
                { "Toxic_Ooze",         new Spell("Toxic_Ooze",          1.5f,   4, DamageType.Magical, Status.Poisoned, true, true) },
                { "Toxic_Dagger",       new Spell("Toxic_Dagger",        2f,   6, DamageType.Phisical, Status.Poisoned,true, true) },
                { "Trick",              new Spell("Trick",               1.5f,   8, DamageType.Other,    Status.Weakness,   false, true) },
